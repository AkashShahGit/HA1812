...
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/HeliumEdgeCJobJobSetting/JobSettingButton'))
WebUI.delay(3)
WebUI.click(findTestObject('Object Repository/HeliumEdgeCJobExtraFeature/Previous'))
WebUI.delay(3)
